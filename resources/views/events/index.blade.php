...
@section('content')
    <section class="bg-gradient-to-br from-indigo-50 via-white to-rose-50">
        <div class="mx-auto max-w-5xl px-4 py-16 lg:px-6">
            <span class="inline-flex items-center gap-2 rounded-full bg-white/80 px-3 py-1 text-sm font-semibold text-indigo-600 shadow-sm ring-1 ring-indigo-100">🎉 events</span>
            <h1 class="mt-4 text-3xl font-black text-slate-900 sm:text-4xl">Upcoming events</h1>
            <p class="mt-3 text-lg text-slate-600">Find concerts, pop-ups, launches, and curated happenings across the city.</p>
        </div>
    </section>
    ...
    <div class="mx-auto max-w-6xl px-4 py-12 lg:px-6">
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            @empty
                <div class="rounded-xl border border-dashed border-slate-200 bg-white p-6 text-center text-slate-600">No events published yet.</div>
            @endforelse
        </div>
