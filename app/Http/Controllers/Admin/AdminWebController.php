...
class AdminWebController extends Controller
{
    ...
    public function storeEvent(Request $request)
    {
        $data = $request->validate([
            ...
            'banner_files.*' => ['nullable', 'file', 'mimes:jpg,jpeg,png,webp,gif,mp4,webm,mov,m4v,ogg,avi,mkv', 'max:20480'],
    ...
    public function storeOffer(Request $request)
    {
        $data = $request->validate([
            ...
            'gallery_sort_order_new' => ['nullable', 'array'],
            'videos.*' => ['nullable', 'file', 'mimes:mp4,webm,mov,m4v,ogg,avi,mkv', 'max:20480'],
            'category_id' => ['nullable', 'exists:categories,id'],
            'organization_id' => ['nullable', 'exists:users,id'],
